...
import Footer from "@/components/FooterRecommendations";
    ...
    <div className="min-h-screen flex flex-col justify-between bg-slate-950 text-white">
      ...
      <main className="p-8 flex-1">
        ...
        <p className="text-slate-400 mb-6">
          ...
          <code className="bg-slate-800 px-2 py-1 rounded mx-1 text-yellow-400">src/components/FooterRecommendations.tsx</code>
        </p>
